...
private:
                            ...
                            uint32_t relPosFlags)
  {
    ...
    if (ubxData.baseRelH >= 3600)
      ubxData.baseRelH -= 3600;
    if (ubxData.baseRelH < 0)
      ubxData.baseRelH += 3600;
    ...
    if (debug)
    {
      ...
      Serial.print(" ");
      Serial.print((ubxData.iTOW % 1000) / 10);
      Serial.print(" ");
      Serial.print(ubxData.baseRelH, 2);
    }
    ...
    if (ubxData.carrSoln > 1)
    { // 1 - float, 2 - full RTK
      if (ubxData.baseRelL == 0)
        ubxData.baseRelL += 0.01; // to prevent 0 division error
    ...
    {
      Serial.print(" ");
      Serial.print(ubxData.baseRelRoll, 2);
                      ...
                      signed long headVeh)
  {
    ...
    if (debug)
    {
      Serial.print("\r\n");
      Serial.print(millis());
      Serial.print(" PVT update ");
      Serial.print(millis() - prevPvtMsgTime);
      Serial.print(" ");
      Serial.print((double)iTOW / 1000.0, 2);
    }
