...
Teensy Serial 7 to RS232 chip
Teensy Serial 2 to ESP32
I2C uses Wire for Section control
...
#define I2C_WIRE Wire           // used for PCA9685 section outputs

// ********* Serial Assignments *********
HardwareSerial* SerialIMU = &Serial6;   // IMU BNO-085 in RVC serial mode
#define SerialRTK Serial3               // RTK radio
#define SerialGPS1 Serial5              // Main postion receiver (GGA & VTG)
#define SerialGPS2 Serial8              // Dual heading receiver  (relposNED)
